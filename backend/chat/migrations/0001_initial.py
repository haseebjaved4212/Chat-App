    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_file', models.FileField(blank=True, null=True, upload_to='chat_media/', validators=[chat.utils.validate_file_size, chat.utils.validate_file_extension])),
                ('media_thumbnail', models.ImageField(blank=True, null=True, upload_to='chat_media/thumbnails/')),
